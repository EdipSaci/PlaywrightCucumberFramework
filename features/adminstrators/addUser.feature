...
Feature: Add Users Functionality
    ...
    #* AC: Admin users should be able to see Add User button on the "Users" page
    #* AC: Admin should be able add student user and admin user to the application

    #! Please make sure to set the status of the newly added to "Inactive" after automate is done
