...
Feature: Borrowing books
    ...
    #* AC2: The Borrow Book button should be displayed after user clicks it
    ...
    #TODO: Verify that the Borrow Book button is displayed in the "Books" Page
    #TODO: Verify that the Borrow Book button is displayed if the book is already borrowed by a student
    #TODO: Verify that the Borrow Book button is enabled if the book is not borrowed by a student yet
    #TODO: Verify that the name of the student is displayed in the Borrowed By column one the student
